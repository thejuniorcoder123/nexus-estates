...
import ContactAgentForm from '@/components/ContactAgentForm'; // 1. IMPORT THE NEW FORM
  ...
  return (
    <>
      ...
      <main className="container" style={{ paddingTop: '40px' }}>
        {/* ... existing gallery and header sections ... */}
        <div className="property-gallery" style={{ marginBottom: '30px', position: 'relative', width: '100%', height: '500px' }}>
          <Image src={property.image} alt={property.title} fill style={{ objectFit: 'cover', borderRadius: '8px' }} />
        </div>
        <div className="property-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
          ...
          <div className="property-price" style={{ fontSize: '2.5rem' }}>{property.price}</div>
        </div>


        <div className="property-layout" style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '30px' }}>
          {/* ... existing property-main section ... */}
          ...
          <div className="property-sidebar">
            {/* 2. REPLACE the old form with our new component */}
            <ContactAgentForm />
          </div>
        </div>
